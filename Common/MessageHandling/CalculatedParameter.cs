...
namespace ABB.InSecTT.Common.MessageHandling
{
    internal class CalculatedParameter: IParameter        
    {
        ...
        private IParameter CalucatedParam { get { return m_calculation(m_parameters); } }

        public bool IsInput => CalucatedParam.IsInput;

        public bool IsOutput => CalucatedParam.IsOutput;

        public double AnalogValue { get => CalucatedParam.AnalogValue; set { } }
        public bool DigitalValue { get => CalucatedParam.DigitalValue; set { } }

        public ParameterType ValueType => CalucatedParam.ValueType;
